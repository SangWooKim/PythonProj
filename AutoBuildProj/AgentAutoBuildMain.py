...
if __name__ == "__main__":
    ...
    OMAgentFullBuild = [
        ...
        , ['{0}\\nt\\WindowUI\\NGFAgent\\NGFAgent.sln'.format(agent_proj_trunk), '/t:Rebuild /p:Configuration=Release_Anycatcher']
        ...
        , ['{0}\\nt\\WindowUI\\NGFAgent\\NGFAgent.sln'.format(agent_proj_trunk), '/t:Rebuild /p:Configuration=Release_Anycatcher /p:Platform=x64']
